  ...
  jQuery(document).ready(function(e) {
    ...
    if (a.isSet("compare") ? r = a.get("compare") : a.set("compare", {}), e(document).on("click", ".compare", function(t) {
      ...
      if (Object.keys(r).length >= 100) swal({
        ...
        s && (a.set("compare", r), n(), c.addClass("add-success"), e("[data-pid='" + o + "']").addClass("added").html('<i class="fas fa-exchange-alt"></i><span> Compare</span>'))
      }
      e(".loading-modal").hide(500)
    }), e(document).on("click", ".remove-compare", function(t) {
      t.preventDefault();
      var c = e(this).data("handle");
      e("." + c).fadeOut(600).remove(), e("[data-pid='" + c + "']").removeClass("added add-success").html('<i class="fas fa-exchange-alt"></i><span> Compare</span>'), e.each(r, function(e, t) {
        t == c && (r[e] = "", delete r[e])
      }), a.set("compare", r)
      ...
      e.each(r, function(t, a) {
        e("[data-pid='" + a + "']").addClass("added").html('<i class="fas fa-exchange-alt"></i><span> Compare</span>');
        var r = "/products/" + a + ".js";
